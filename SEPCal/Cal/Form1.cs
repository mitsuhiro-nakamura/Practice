...
namespace Cal
{
    public partial class Form1 : Form
    {
        ...
        int[] sum = new int[2];               //  演算対象の値
        int[] sumBack = new int[2];           //  sumの値をバックアップ
        int[] sumFullBack = new int[15];      //  sumの値を入力毎バックアップ
        int smallNumberLevel = 1;                //  少数の位置の計算
        int ans = 0;                             //  演算結果
        ...
        private void ASRope_Click(object sender, EventArgs e)
        {
            ASR(sum[0]);
        }
    }
